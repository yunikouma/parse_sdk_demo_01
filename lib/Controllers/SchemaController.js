...
class SchemaController {
  ...
  addClassIfNotExists(className, fields = {}, classLevelPermissions) {
    ...
    return this._dbAdapter.createClass(className, convertSchemaToAdapterSchema({ fields, classLevelPermissions, className })).then(convertAdapterSchemaToParseSchema).then(res => {
  ...
  setPermissions(className, perms, newSchema) {
    ...
    return this._dbAdapter.setClassLevelPermissions(className, perms).then(() => this.reloadData({ clearCache: true }));
  }
